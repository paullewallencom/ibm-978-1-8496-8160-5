...
public class Persistence
{
    ...
    public BooklookUser getUser(String username, String encryptedPassword)
    {
        ...
        List<BooklookUser> user = getSessionFactory().openSession().createQuery("from BooklookUser where username = '" + username + "' and password = '" + encryptedPassword +"'").list();
    ...
    {
        return getSessionFactory().openSession().createQuery("from BooklookUser").list();
    }
